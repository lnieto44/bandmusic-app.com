...
public class MainActivityAdmin extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.asignar_jurados) {
           Intent searchIntent = new Intent(MainActivityAdmin.this, Asignar_Jurado.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);

        } else if (id == R.id.registrar_banda) {
           Intent searchIntent = new Intent(MainActivityAdmin.this, Registrar_Banda.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);

        } else if (id == R.id.crear_evento) {
            Intent searchIntent = new Intent(MainActivityAdmin.this,Crear_Eventos.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
            ...
            Intent searchIntent = new Intent(MainActivityAdmin.this,Cerrar_Sesion.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }
